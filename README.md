...
[![Установить расширение](https://img.shields.io/badge/Установить_расширение-Кинопоиск_[Free]-4CAF50?style=for-the-badge&logo=github)](https://raw.githubusercontent.com/murckich/kinopoisk-free/main/kinopoisk-free.user.js)
...
Расширение настроено на автоматическое обновление. Как только вы выложите новую версию в этот репозиторий, Tampermonkey уведомит всех пользователей о доступном обновлении.
